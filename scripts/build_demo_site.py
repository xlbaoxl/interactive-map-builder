...
<span class="accent">dist/</span>
  ...
  build_report.json</pre></div>
    ...
    <section id="demos" class="section"><div class="shell"><div class="eyebrow">REAL DATA · REAL GENERATED HTML</div><h2>Two map products, not two screenshots.</h2><p class="lead">Both demos are built from fixed NYC Open Data snapshots by the same deterministic engine shipped in the repository.</p><div class="demos">
      ...
      <article class="demo"><div class="demo-copy"><span>MULTILAYER</span><h3>Downtown Brooklyn mobility context</h3><p>Inspect subway stations, bicycle routes and neighborhoods with independent visibility, business-layer search and consistent map controls.</p></div><div class="frame"><iframe title="Downtown Brooklyn multilayer explorer" src="./multilayer/" loading="lazy"></iframe></div><a class="demo-link" href="./multilayer/"><span>Open live map ↗</span></a></article>
    </div></div></section>
